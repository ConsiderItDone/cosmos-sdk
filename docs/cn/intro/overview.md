...
- Cosmos SDK 默认的共识引擎是[Tendermint Core](https://github.com/consideritdone/landslide-tendermint). Tendermint 是目前最成熟的、唯一的 BFT 共识引擎。它被广泛应用于行业中，被认为是构建 POS 系统的最佳标准共识引擎。
