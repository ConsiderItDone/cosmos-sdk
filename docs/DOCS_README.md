...
much as possible with its [counterpart in the Tendermint Core repo](https://github.com/consideritdone/landslide-tendermint/blob/v0.34.0/docs/DOCS_README.md).
