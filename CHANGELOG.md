...
* (deps) [\#10375](https://github.com/cosmos/cosmos-sdk/pull/10375) Bump Tendermint to [v0.34.14](https://github.com/consideritdone/landslide-tendermint/releases/tag/v0.34.14).
...
* (deps) [\#9956](https://github.com/cosmos/cosmos-sdk/pull/9956) Bump Tendermint to [v0.34.12](https://github.com/consideritdone/landslide-tendermint/releases/tag/v0.34.12).
...
* (tendermint) Bump Tendermint version to [v0.34.3](https://github.com/consideritdone/landslide-tendermint/releases/tag/v0.34.3).
...
* (tendermint) Bump Tendermint version to [v0.33.6](https://github.com/consideritdone/landslide-tendermint/releases/tag/v0.33.6).
...
* (tendermint) Bump Tendermint version to [v0.33.3](https://github.com/consideritdone/landslide-tendermint/releases/tag/v0.33.3).
...
* (tendermint) Bump Tendermint version to [v0.32.13](https://github.com/consideritdone/landslide-tendermint/releases/tag/v0.32.13).
...
* (tendermint) Bump Tendermint version to [v0.32.12](https://github.com/consideritdone/landslide-tendermint/releases/tag/v0.32.12).
...
* (tendermint) Bump Tendermint version to [v0.32.11](https://github.com/consideritdone/landslide-tendermint/releases/tag/v0.32.11).
...
* (tendermint) Bump Tendermint version to [v0.32.10](https://github.com/consideritdone/landslide-tendermint/releases/tag/v0.32.10).
...
* (tendermint) Bump Tendermint version to [v0.32.9](https://github.com/consideritdone/landslide-tendermint/releases/tag/v0.32.9)
...
* (tendermint) Bump Tendermint version to [v0.32.8](https://github.com/consideritdone/landslide-tendermint/releases/tag/v0.32.8)
...
* (tendermint) Bump Tendermint version to [v0.32.7](https://github.com/consideritdone/landslide-tendermint/releases/tag/v0.32.7)
...
* (tendermint) Bump Tendermint version to [v0.32.6](https://github.com/consideritdone/landslide-tendermint/releases/tag/v0.32.6)
...
* Bump Tendermint version to [v0.31.11](https://github.com/consideritdone/landslide-tendermint/releases/tag/v0.31.11) to address the vulnerability found in the `consensus` package.

## 0.34.9

### Bug Fixes

* Bump Tendermint version to [v0.31.10](https://github.com/consideritdone/landslide-tendermint/releases/tag/v0.31.10) to address p2p panic errors.
...
* Tendermint
  * [\#2797](https://github.com/consideritdone/landslide-tendermint/pull/2797) AddressBook requires addresses to have IDs; Do not crap out immediately after sending pex addrs in seed mode
...
* Tendermint
  * Update tendermint version from v0.23.0 to v0.25.0, notable changes
    ...
    * See the [tendermint changelog](https://github.com/consideritdone/landslide-tendermint/blob/master/CHANGELOG.md) for other changes.
...
* Gaia
    ...
    * [x/auth] Signature verification's gas cost now accounts for pubkey type. [#2046](https://github.com/consideritdone/landslide-tendermint/pull/2046)
    * [x/stake] [x/slashing] Ensure delegation invariants to jailed validators [#1883](https://github.com/cosmos/cosmos-sdk/issues/1883).
    * [x/stake] Improve speed of GetValidator, which was shown to be a performance bottleneck. [#2046](https://github.com/consideritdone/landslide-tendermint/pull/2200)
...
* Tendermint
    - v0.22.5 -> See [Tendermint PR](https://github.com/consideritdone/landslide-tendermint/pull/1966)
        - change all the cryptography imports.
    - v0.23.0 -> See
      [Changelog](https://github.com/consideritdone/landslide-tendermint/blob/v0.23.0/CHANGELOG.md#0230)
...
see the [docs](https://github.com/consideritdone/landslide-tendermint/blob/v0.19.1/docs/specification/new-spec/encoding.md#public-key-cryptography).
